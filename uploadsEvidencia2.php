       ...
       if(isset($_GET['service'])){
        ...
        if(isset($_POST['submit'])){ 
            ...
            if($arquivoNovo[sizeof($arquivoNovo)-1] != 'jpg'){
              ...
              window.location.href='uploadsEvidencia2.php?vai=$vai&service=$serviceNome'
                 </script>";
            }else{
                mkdir(__DIR__.'/uploads/'.$serviceNome.'/', 0777, true);
            move_uploaded_file($arquivo['tmp_name'],'uploads/'.$serviceNome.'/'.$serviceNome."_Evidencia2.jpg");
            header("location:acessorios.php?vai=$vai&service=$serviceNome");
    }
}
    ?>
...
<form action="./uploadsEvidencia2.php?vai=<?php echo $vai ?>" method="post" enctype="multipart/form-data">
        <h1>Foto de Evidencia 2:</h1>
